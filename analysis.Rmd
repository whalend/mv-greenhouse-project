...
avg_gh_data$Herbivory <- factor(avg_gh_data$Herbivory, levels = c("N","Y"), labels = c("No Herbivory", "Herbivory"))
ggplot(filter(avg_gh_data), 
       aes(factor(pop_lat), avg_flower_date, fill = Light)) +
...
# ggplot(avg_gh_data,
#        aes(Light, avg_flower_date, color = as.numeric(Lat))) +
#   # geom_boxplot()+
