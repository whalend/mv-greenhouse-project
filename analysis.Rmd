...
author: "K.B. Stricker, Amy Kendig, W.W. Dillon, S.L. Flory"
date: "11/27/2017"
...
Kerry asked me to check over her models, so I (WD) will likely be making some additions and revisions to this as I go.
...
ggplot(avg_gh_data_light, 
       aes(Light, avg_sla, color = as.numeric(pop_lat))) +
  # geom_boxplot()+
  geom_path(aes(group = pop_lat)) +
  geom_point(size = 2) +
  # geom_smooth(aes(linetype = Light), method = "lm", se = F) +
