...
# [1] 316
m3.2<-lmer(HarvestOrdDate~Light*Herbivory*Lat+(1|Block),data=harvest) 
## the data frame "harvest" contains all GH data except for row 316.
